...
export class DashboardComponent implements OnInit {
    ...
    ngOnInit() {
        var res = {"grid":{"gridType":"fit","colWidth":0,"rowHeight":0,"margin":13},"components":[{"compId":"app_view2","compName":"产品风险准备金","isDisplay":1,"isMaxenable":0,"width":2,"height":1,"x":0,"y":0,"param":""},{"compId":"app_view5","compName":"理财资金流向行业","isDisplay":1,"isMaxenable":1,"width":4,"height":3,"x":0,"y":1,"param":""},{"compId":"app_view7","compName":"投资资产类型收益变化","isDisplay":1,"isMaxenable":1,"width":8,"height":3,"x":0,"y":4,"param":""},{"compId":"app_view8","compName":"收益类型净值变动","isDisplay":1,"isMaxenable":1,"width":8,"height":3,"x":0,"y":7,"param":""},{"compId":"app_view9","compName":"待办事项","isDisplay":1,"isMaxenable":1,"width":3,"height":4,"x":0,"y":10,"param":""},{"compId":"app_view1","compName":"非标资管占比","isDisplay":1,"isMaxenable":0,"width":2,"height":1,"x":2,"y":0,"param":""},{"compId":"app_view10","compName":"日历","isDisplay":1,"isMaxenable":1,"width":5,"height":4,"x":3,"y":10,"param":""},{"compId":"app_view3","compName":"客户风险评估率","isDisplay":1,"isMaxenable":0,"width":2,"height":1,"x":4,"y":0,"param":""},{"compId":"app_view6","compName":"全面风险管理资本计提","isDisplay":1,"isMaxenable":1,"width":4,"height":3,"x":4,"y":1,"param":""},{"compId":"app_view4","compName":"理财产品杠杆比率","isDisplay":1,"isMaxenable":0,"width":2,"height":1,"x":6,"y":0,"param":""}]};
        ...
        Promise.resolve(null).then(() =>   this.notify['success']('你好！', '欢迎登录产品与风险管理系统'));
        this.query('admin');
        const self = this;
        this.options = {
            gridType: 'fit',
